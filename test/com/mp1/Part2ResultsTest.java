...
public class Part2ResultsTest {
    ...
    public void manhattanDistanceHeuristicOpenMaze() {
        this.runMaze(new AStarPenalizingTurnsSearch("openMaze.txt", 1, 2, new ManhattanDistanceHeuristic()), "openMaze.txt", "ManhattanDistance", 1, 2, 70, 501);
        this.runMaze(new AStarPenalizingTurnsSearch("openMaze.txt", 2, 1, new ManhattanDistanceHeuristic()), "openMaze.txt", "ManhattanDistance", 2, 1, 116, 906);
    }

    @Test
    public void turnsHeuristicOpenMaze() {
        this.runMaze(new AStarPenalizingTurnsSearch("openMaze.txt", 1, 2, new TurnsHeuristic(1, 2)), "openMaze.txt", "TurnsHeuristic", 1, 2, 70, 391);
        this.runMaze(new AStarPenalizingTurnsSearch("openMaze.txt", 2, 1, new TurnsHeuristic(2, 1)), "openMaze.txt", "TurnsHeuristic", 2, 1, 116, 391);
    }
	...
	public void turnsHeuristicSmallTurns() {
		this.runMaze(new AStarPenalizingTurnsSearch("smallTurns.txt", 1, 2, new TurnsHeuristic(1, 2)), "smallTurns.txt", "TurnsHeuristic", 1, 2, 74, 376);
		this.runMaze(new AStarPenalizingTurnsSearch("smallTurns.txt", 2, 1, new TurnsHeuristic(2, 1)), "smallTurns.txt", "TurnsHeuristic", 2, 1, 120, 265);
	}
    ...
    public void turnsHeuristicMediumTurns() {
        this.runMaze(new AStarPenalizingTurnsSearch("mediumTurns.txt", 1, 2, new TurnsHeuristic(1, 2)), "mediumTurns.txt", "TurnsHeuristic", 1, 2, 58, 397);
        this.runMaze(new AStarPenalizingTurnsSearch("mediumTurns.txt", 2, 1, new TurnsHeuristic(2, 1)), "mediumTurns.txt", "TurnsHeuristic", 2, 1, 93, 356);
    }
    ...
    public void turnsHeuristicBigTurns() {
        this.runMaze(new AStarPenalizingTurnsSearch("bigTurns.txt", 1, 2, new TurnsHeuristic(1, 2)), "bigTurns.txt", "TurnsHeuristic", 1, 2, 90, 1513);
        this.runMaze(new AStarPenalizingTurnsSearch("bigTurns.txt", 2, 1, new TurnsHeuristic(2, 1)), "bigTurns.txt", "TurnsHeuristic", 2, 1, 133, 971);
    }
    ...
    public void turnsHeuristicHugeTurns() {
        this.runMaze(new AStarPenalizingTurnsSearch("hugeTurns.txt", 1, 2, new TurnsHeuristic(1, 2)), "hugeTurns.txt", "TurnsHeuristic", 1, 2, 114, 1924);
        this.runMaze(new AStarPenalizingTurnsSearch("hugeTurns.txt", 2, 1, new TurnsHeuristic(2, 1)), "hugeTurns.txt", "TurnsHeuristic", 2, 1, 194, 2049);
    }
