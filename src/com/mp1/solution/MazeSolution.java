...
//			System.out.println(finalNode.getState().x + " " + finalNode.getState().y + " -- ghost" + finalNode.getState().ghostCoordinates.get(3).x + " " + finalNode.getState().ghostCoordinates.get(3).y);
